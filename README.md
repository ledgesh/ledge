...
**iPhone and iPad.** The iOS app is on the same releases page. It connects
over ssh to a Linux server or to your Mac, and reads, edits, and runs the
same notes from anywhere.
