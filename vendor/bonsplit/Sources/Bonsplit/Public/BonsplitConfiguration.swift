...
public struct BonsplitConfiguration: Sendable {
    ...
    /// Whether a tab can be renamed in place, via its context menu or a
    /// double-click on the tab.
    public var allowTabRename: Bool
    ...
    public init(
        ...
        self.allowTabRename = allowTabRename
