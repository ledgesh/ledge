// The Ledge MCP server: how agents read the user's notes. Agent CLIs (Claude
 ...
 * client that skipped the handshake protects nothing here: every tool is
 * read-only over files the agent's own shell could read anyway.
 */
